...
\begin{example}[2]
    ...
    Méthode des résidus avec $g(z) = f(z) e^{i5x} = \frac{e^{i5x}}{x^2 + 1}$.
    ...
    \[
        ...
        = \lim_{z \rightarrow i} (z - i) \frac{e^{izx}}{(z - i)(z + i)}
        = \frac{e^{i5z}}{2i}
        = \frac{e^{-5}}{2i}
    \]
    ...
    \[
        \int_{-\infty}^\infty \frac{e^{i5x}}{x^2 + 1} \dx = 2\pi \Res_i (g) = 2\pi i \frac{e^{-5}}{2i} = \frac{\pi}{e^{5}}
    \]
